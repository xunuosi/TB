...
import io.github.xunuosi.tb.views.widget.RateTextCircularProgressBar;
...
public class ToastUtil {
    ...
    public ToastUtil(Context context, int layoutId, String msg , int type) {
        message = msg;
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //自定义布局
        View view = inflater.inflate(layoutId, null);
        ...
        mRateTextCircularProgressBar = (RateTextCircularProgressBar)view.findViewById(R.id.rate_progress_bar);
    ...
    public void setMax( int max ) {
        mRateTextCircularProgressBar.setMax(max);
    }
    public void updateProgressValue(int value){
        mRateTextCircularProgressBar.setProgress(value);
    }
    /**
     * 自定义居中显示toast
     */
